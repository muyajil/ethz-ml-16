...
'''
This script takes the output file of reas_data_fast.py and trains the model
with lasso. The predictions are printed into the file "submission_LASSO.csv".
'''
import sPickle
import sys
...
def do_lasso():
    ...
    if GRID_SEARCH:
        ...
        model = Lasso(max_iter=20000, alpha=184.61)
